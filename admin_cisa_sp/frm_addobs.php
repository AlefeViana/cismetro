   ...
   if ($CdSolCons === 0){
	   ...
	   switch($Acao){
	   		case "edit": $botao = 'Salvar';
						 break;
			case "del": $botao = 'Cancelar Solicita&ccedil;&atilde;o';
						break;
	   }
	   ...
	   $qry = mysqli_query($db,$sql) or die('Ocorreu um erro de número: '.mysqli_errno().', frm_addobs:select dados. Tente executar novamente a tarefa e se o erro persistir, contate o administrador do sistema informando essa mensagem. Copie essa mensagem!');
          ...
          <tr>
          	   <td colspan="2">
				   <?php 
						...
						$qry = mysqli_query($db,$sql) or die ('Ocorreu um erro de número: '.mysqli_errno().', frm_addobs:select status. Tente executar novamente a tarefa e se o erro persistir, contate o administrador do sistema informando essa mensagem. Copie essa mensagem!');
