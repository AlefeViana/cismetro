...
$NmBairro 	= ucwords(mb_strtolower($_POST["nm_bairro"],'ISO-8859-1'));
...
else
{
	if (substr($CdBairro,0,4) == "Auto")
	{
		...
		{			
			...
			$sql = "INSERT INTO tbbairro (CdBairro,NmBairro,CdPref,UserInc)	VALUES($CdBairro,'$NmBairro',$CdPref,$_SESSION[CdUsuario])";	
