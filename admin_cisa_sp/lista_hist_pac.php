      ...
      echo '<center><table width="98%" border="0" id="grid">';
        ...
        //cor da tabela
         ...
         while($l = mysqli_fetch_array($query)){
			   ...
			   //link----------------
				   ...
				   echo "<td align=\"center\"><a href='$link'>
				   			<img src=\"imagens/Print.ico\" border=\"0\" title=\"Visualizar Prescrição\" alt=\"Exibir\" width=\"13\" height=\"13\"></a></td>";
                   echo "</tr>";
         }//fim enquanto
         echo "</table>";
         //fim da tabela
         ...
         if($pag < ($pags - 1)) {
          ...
          echo '<h3><center><font face="verdana","arial" color="FF6464">Nenhuma prescrição encontrada</font></center></h3>';
	  }
