		...
		<table width="100%" border="0" bgcolor="#FFFFFF" cellspacing="5">
		  ...
		  <tr>
           ...
           <tr>
			  ...
			  ?>
	          <td><input type="text" name="dtval" id="dtval" size="7" value="<?php echo $dados_contrato["DtValidade"]; ?>" onblur="if(!valida_data(this.value)){alert('Data inválida.'); this.value = ''; }" /></td>
		  </tr>
          <tr>
		      <td>Arquivo:</td>
	          <td>
