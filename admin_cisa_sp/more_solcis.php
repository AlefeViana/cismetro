	...
	echo "<div class='solicitacoes_grupocis'>
		...
		<tr>	    
		    ...
		    <tr>	
		       <td> Procedimento </td>
		         <td>  
		            <select name='cd_proc[]' required id='cd_proc$count' class='procs' style='width: 150px; height: 30px;'>
		                <option value=''>Selecione um procedimento</option>   ";                      
		                        ...
		                        if (mysqli_num_rows($qry) > 0){
		                            while ($dados = mysqli_fetch_array($qry)){	
		                                echo '<option value="'.$dados["CdProcedimento"].'">'.utf8_decode($dados["NmProcedimento"]).'</option>';
		                            }
		                        } 
		                        @mysqli_close();
		 ...
		 echo" </td>
		        ...
		        <td >  
		             <select name='cd_especcis[]' id='cd_especificacao$count' class='especs' required style='width: 350px; height: 30px;'>
		...
		echo '<tr>
			...
			<td>
				<textarea name="obscis[]" id="obs$count" style="width:400px; height:80px"  onkeyup="blocTexto(this.value)"></textarea>
			</td>
            <td> Urgente </td> 
            <td>
            	<label>
