...
else
{
	if (substr($CdEspecProc,0,4) == "Auto")
	{
		...
		$sql = "INSERT INTO tbespecproc (CdEspecProc,NmEspecProc,CdProcedimento,UserAlt,Status, valor,valorsus,cdsus, desc_sus, cdespecialidade,ppi,bpa,cdgrupoproc, nmpreparo,cid,cdservico,cdclass,valorm,maxano,principal,quemAgendar)
					VALUES($CdEspecProc,'$NmEspecProc',$CdProcedimento,$_SESSION[CdUsuario],'$Status', '$Valor', '$valorsus', '$cdsus', '$desc_sus','$cdespecialidade', '$ppi','$bpa','$cdgrupoproc', '$nmpreparo','$cid','$cdservico','$cdclass','$valorm','$maxano','$principal','$quemAgendar' )";	
