         ...
         while($l = mysqli_fetch_array($query)){
               if ($cortb == "linha2"){
				   ...
				   echo "<td><input type=\"text\" name=\"dtag$l[CdSolCons]\" value=\"$l[DtAgCons]\" size=\"7\" id=\"date\" 
				   			onblur=\"if(!valida_data(this.value)){alert('Data inválida.'); this.value = ''; }\" $disabled /></td>";
                   ...
                   echo "<td><input type=\"text\" name=\"hag$l[CdSolCons]\" value=\"$l[HoraAgCons]\" size=\"2\" id=\"hora\" title=\"$tiphor\" 
				   			onblur=\"if(!valida_horario(this.value)){alert('Hora inválida.'); this.value = ''; }\" $disabled /></td>";
				 ...
				 <img src=\"imagens/document_add.png\" border=\"0\" title=\"Incluir Obs.\" alt=\"Incluir Obs.\" width=\"13\" height=\"13\" /></a></td>";
				  ...
				  <img src=\"imagens/document_delete.png\" border=\"0\" title=\"Cancelar Solicitação\" alt=\"Cancelar\" width=\"13\" height=\"13\" /></a></td>";				
                   echo "</tr>";
         }//fim enquanto
         echo "</table>";
		 //envia as variaveis do formulario de pesquisa para não perder o filtro
