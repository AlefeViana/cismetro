...
if(mysqli_num_rows($sql) > 0){
    ...
    $qry = "INSERT INTO `tbusuario` (`CdTpUsuario`, `NmUsuario`, `Login`, `Senha`, `CdOrigem`, `cdfornecedor`, `cdgrusuario`,`cdprof`) 
    VALUES ('$cCdTpUsuario', '$cNmUsuario', '$cLogin', '$db_senha' , '$cCdOrigem', '$ccdfornecedor', '$ccdgrusuario', '$ccdprof')	";
    //print_r($qry);
    ...
    define('MAILGASSUNTO1','USUÁRIO DE CREDENCIAMENTO');
    ...
    <body style="margin: 0; padding: 0;">
     ...
     <tr>
      <td align="center" bgcolor="#ffffff" style="padding: 40px 0 30px 0;">
       <img src="http://ec2-3-208-31-216.compute-1.amazonaws.com/conivales/pg/credenciamento/icons_email/cabecalho.png" width="400" height="220" style="display: block;" />
      </td>
     </tr>
     <tr>
     ...
     <tr>
      ...
      <td>
       <a href="http://www.sitconsistemas.com.br/" target="_blank">
         <img src="http://ec2-3-208-31-216.compute-1.amazonaws.com/conivales/pg/credenciamento/icons_email/www_icon.png" alt="Site" width="38" height="38" style="display: block;" border="0" />
        </a>
      </td>
      <td style="font-size: 0; line-height: 0;" width="20">&nbsp;</td>
      <td>
       <a href="https://www.instagram.com/sitcon.sistemas/" target="_blank">
         <img src="http://ec2-3-208-31-216.compute-1.amazonaws.com/conivales/pg/credenciamento/icons_email/instagram_icon.png" alt="Instagram" width="38" height="38" style="display: block;" border="0" />
       </a>
      </td>
      <td style="font-size: 0; line-height: 0;" width="20">&nbsp;</td>
      <td>
       <a href="https://www.facebook.com/sitconsistemas/" target="_blank">
         <img src="http://ec2-3-208-31-216.compute-1.amazonaws.com/conivales/pg/credenciamento/icons_email/facebook_icon.png" alt="Facebook" width="38" height="38" style="display: block;" border="0" />
        </a>
      </td>
      <td style="font-size: 0; line-height: 0;" width="20">&nbsp;</td>
      <td>
       <a href="https://api.whatsapp.com/send?phone=5531971028716" target="_blank">
         <img src="http://ec2-3-208-31-216.compute-1.amazonaws.com/conivales/pg/credenciamento/icons_email/whatsapp_icon.png" alt="WhatsApp" width="38" height="38" style="display: block;" border="0" />
       </a>
      </td>
      <td style="font-size: 0; line-height: 0;" width="20">&nbsp;</td>
      <td>
       <a href="https://www.youtube.com/channel/UCwaftxrfrvBdbxJLiIcLnBg" target="_blank">
         <img src="http://ec2-3-208-31-216.compute-1.amazonaws.com/conivales/pg/credenciamento/icons_email/youtube_icon.png" alt="YouTube" width="38" height="38" style="display: block;" border="0" />
       </a>
      </td>
     </tr>
    </table>
