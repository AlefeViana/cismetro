        ...
        $body = <<<EOT
            <!DOCTYPE html>
                ...
                <td align="center" bgcolor="#ffffff" style="padding: 40px 0 30px 0;">
                    <img src="https://develop.nuvemsitcon.com.br/cismetro/pg/credenciamento/icons_email/cabecalho_conf.png" width="400" height="220" style="display: block;" />
                </td>
                </tr>
                <tr>
                ...
                <td id="confirmacao" align="justify" style="padding: 0px 0 30px 0;">
                    Para finalizar seu cadastro no processo de credenciamento do CONIVALES, clique no link a seguir :
                </td>
                </tr>
                <tr>
                <td id="link">
                    <a href="https://develop.nuvemsitcon.com.br/cismetro/login_conf_cred.php?c=$cnpj&e=$Email"> Clique aqui para confirmar sua inscrição!</a>
                </td>
                </tr>
                </table>
                </td>
