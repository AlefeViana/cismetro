...
if(mysqli_num_rows($sql) > 0){
    ...
    //print_r($qry);
    $sql = mysqli_query($db,$qry) or die (mysqli_error());
    ...
    $mail->Subject  = ' USUÁRIO DE CREDENCIAMENTO'; 
    $mail->isHTML(true);
    ...
    $mail->AddEmbeddedImage('./pg/credenciamento/icons_email/cabecalho.png', 'cabecalho');
    $mail->Body 	= '
    <!DOCTYPE html>
    <html lang="pt-br">
    <head>
    ...
    $mail->AltBody 	= ' Criação de usuário de credenciamento';
    ...
    if($enviado){
        echo '<script type="text/javascript">
                 alert("Seu login de acesso foi criado e enviado para o email!");
                 window.location.href="index.php";
              </script>';
    }else{
        echo '<script type="text/javascript">
                alert("Falha ao criar login, verifique o dados informados ou entre em contato com o consórcio!");
              </script>';
    }
}
?>