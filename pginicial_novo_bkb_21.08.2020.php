...
$(document).ready(function () {
   ...
   $('.open-contrato').click(function (e) { 
    ...
    $(document).on('click','.irFP',function () { 
        window.open("https://iconsorciosaude19.com.br/cismetro/index.php?i=6");  
    });
    $(document).on('click','.irFP-imp',function () { 
        window.open("https://iconsorciosaude19.com.br/cismetro/index.php?i=6&imp=N");  
    });
    $(document).on('click','.irCred',function () { 
        window.open("https://iconsorciosaude19.com.br/cismetro/index.php?i=160");  
    });
    $(document).on('click','.irAGD',function () { 
        window.open("https://iconsorciosaude19.com.br/cismetro/index.php?i=151");  
    });
    $(document).on('click','.irAGDF',function () { 
        window.open("https://iconsorciosaude19.com.br/cismetro/index.php?i=168");  
    });
    ...
    $(document).on('click','.VerD', function (){console.log(doc); $(".sub-list").html(doc); });
    $(document).on('click','.VerF', function (){ $(".sub-list").html(forn); });
                ...
                <div class="card-header text-white bg-info">
                    ...
                    <ul class="list-group list-group-flush">
                        <?php
                            ...
                            {
                                echo '<li class="list-group-item noticia" data-f='.$lin['foto'].' data-t='.$lin['titulo'].' data-a='.$lin['autor'].' data-c='.$lin['corpo'].' ><i class="far fa-newspaper"></i>  '. $lin['titulo'] .'  <span style="font-size: 11px; color: #227cdae0;  font-style: italic;"> Autor : '.$lin['autor'].'</span></li>';
                            }
                        ?>
                    </ul>
                </div>
