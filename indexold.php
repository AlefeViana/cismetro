...
<div id="busca_top" style="float:right; margin-top:30px; margin-right:96px; ;">  
       			...
       			<li style="color:#FFF; margin-bottom:7px; padding:">  <?php if (isset($_SESSION["CdUsuario"])) echo ''.$_SESSION["Login"];echo ''.$_SESSION["nmgrusuario"]; ?>, <span style="color:#000; text-decoration:underline"> 
