...
<body class="text-center" style="background-image: linear-gradient(to right, white, #52ACEA, #145480)">
						...
						<form method="POST" action="login_valida.php">
							...
							<div class="input-group mb-3" id="mun_consorcio" hiden>
								...
								<select name="cdmun" class="form-control"  id="cdmun">
									...
									<option value="245">ÁGUAS DE SÃO PEDRO</option>
									<option value="125">AMERICANA</option>
									<option value="9">AMPARO</option>
									<option value="2">ARTUR NOGUEIRA</option>
									<option value="7">CORDEIRÓPOLIS</option>
									<option value="3">COSMÓPOLIS</option>
									<option value="183">ENGENHEIRO COELHO</option>
									<option value="1">HOLAMBRA</option>
									<option value="14">IPEÚNA</option>
									<option value="10">IRACEMÁPOLIS</option>
									<option value="12">JAGUARIÚNA</option>
									<option value="13">LIMEIRA</option>
									<option value="11">MONTE MOR</option>
									<option value="6">MORUNGABA</option>
									<option value="132">NOVA ODESSA</option>
									<option value="4">PAULÍNIA</option>
									<option value="17">RIO CLARO</option>
									<option value="8">SANTA GERTRUDES</option>
									<option value="5">SANTO ANTÔNIO DE POSSE</option>
									<option value="189">VALINHOS</option>
									<option value="257">VÁRZEA PAULISTA</option>
	...
	$(document).ready(function () {
		...
		$('#usuario').blur(function (e) { 
			e.preventDefault();
			const user = $(this).val();
			if(user == 'MUN.CISMETRO' || user == 'mun.cismetro'){
				$('#mun_consorcio').show();
			}else{
				$('#mun_consorcio').hide();
			}
