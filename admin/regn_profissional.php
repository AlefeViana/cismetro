...
{
	if (substr($cdprof,0,4) == "Auto" && $acao != "edit" && $acao != "del")
	{
		require("../conecta.php");
		//gera um novo codigo
		...
		$sql = "INSERT INTO tbprofissional (nmprof,cnsprof,crm,usrinc,dtinc,AssinaturaScan,credenciado) VALUES('$nmprof','$cnsprof','$crm','$usrinc','$dtinc', '$caminho', '&credenciado')";	
		$qry = mysqli_query($db,$sql);

		$cdprof = mysqli_insert_id($db);
	...
	else
	{
		...
		if($acao == "edit" && $acao != "del")
		{
			...
			echo '<script language="JavaScript" type="text/javascript"> 
				...
				window.location.href="../index.php?i=69&s=n&id='.$id.'&acao=edit";				
			  </script>';
		}
		else
		{
