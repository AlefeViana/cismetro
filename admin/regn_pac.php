...
/* 	if(!$cpf){
	...
	if ($action == "cad") {
		...
		$sql = 'INSERT INTO 
		tbpaciente 
		(is_notifiable,CdBairro,NmPaciente,RG,orgaorg,CPF,OutrosDocs,Sexo,DtNasc,Naturalidade,Nacionalidade,NmMae,NmPai,Telefone,Celular,Email,Profissao,Logradouro,Numero,Compl,CEP,Referencia,cdupa,UserInc,csus,cdlogr,CertidaoMatricula, Matricula, Prontuario, cdunidade) 		
		VALUES
		( "'.$isNotifiable.'", "'.$neighborhood->id.'","'.$paciente_nome.'","'.$RG.'","'.$orgaorg.'","'.$cpf.'","'.$OutrosDocs.'","'.$sexo.'","'.$data_de_nascimento.'","'.$Natural.'","'.$nacionalidade.'","'.$nome_da_mae.'","'.$PaiPac.'","'.$telefone.'","'.$celular.'","'.$Email.'","'.$Profissao.'","'.$logradouro.'","'.$numero.'","'.$Compl.'","'.$cep.'","'.$Referencia.'","'.$cdupa.'","'.$user_id.'","'.$csus.'","'.$logradouro_id.'","'.$CertidaoMatricula.'", "'.$matricula.'", "'.$numprontuario.'", "'.$cdunidade.'")';
