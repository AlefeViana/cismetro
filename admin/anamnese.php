...
$(document).ready(function() {
	...
	function criaGrid(){
		...
		grid.setTextMatrix(0,0,"C�digo");
		grid.setTextMatrix(0,1,"Medica��o");
	...
	function criaGrid1(){
		...
		grid1.setTextMatrix(0,0,"C�digo");
		grid1.setTextMatrix(0,1,"Doen�a");
	...
	function criaGrid2(){
		...
		grid2.setTextMatrix(0,0,"C�digo");
