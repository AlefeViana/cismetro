...
<?php
	...
	//identifica se � a primeira chamada quando o usuario entra no modo de edi��o, utilizado para limpar as variaveis de sess�o
	...
	//Recupera dados salvo na sess�o
	if(isset($_SESSION["dados_rec"])){
		...
		//colocar a data no formato americano e testar o cadastro de bairro na edi��o do paciente
