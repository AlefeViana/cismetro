...
class Agendamento implements JsonSerializable
{
    ...
    private function search($conditions, $limit)
    {
        $query = "SELECT 
            sl.CdSolCons AS id,
            pref.CdPref AS county_id,
            pref.NmCidade AS county_name,
            ...
            esp.NmEspecProc AS procedimento,
            forn.CdForn AS fornecedor_id,
    ...
    function show($condition = "WHERE sl.CdSolCons = ?")
    {
        ...
        $this->connection_id = defined("CONNECTION_ID") ? CONNECTION_ID : NULL;
    }
    ...
    /**
     * Set agendamento status to cancelled
     */
    ...
    public function cancel()
    {
        ...
        "UPDATE " .
            $this->table_name .
            "  SET  Status = 1 WHERE CdSolCons = :id;
